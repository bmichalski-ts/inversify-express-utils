                ...
                switch (_a.label) {
                    case 0:
                        this._container
                            ...
                            .toConstantValue({});
                        constructors = getControllersFromMetadata();
                        ...
                        return [4, getControllersFromContainer(this._container, this._forceControllers)];
                    case 1:
                        controllers = _a.sent();
                        return [4, Promise.all(controllers.map(function (controller) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            controllerMetadata = getControllerMetadata(controller.constructor);
                                            methodMetadata = getControllerMethodMetadata(controller.constructor);
                                            parameterMetadata = getControllerParameterMetadata(controller.constructor);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, (_a = httpContext.container.getNamed(TYPE.Controller, controllerName))[key].apply(_a, args)];
                    case 1:
                        value = _b.sent();
                        if (!(value instanceof HttpResponseMessage)) return [3, 3];
                        return [4, this.handleHttpResponseMessage(value, res)];
                    case 2:
                        _b.sent();
                        return [3, 7];
                    case 3:
                        if (!instanceOfIHttpActionResult(value)) return [3, 6];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this._container.getAsync(TYPE.AuthProvider)];
                    case 1:
