...
export var getControllersFromContainer = function (container, forceControllers) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (container.isBound(TYPE.Controller)) {
            return [2, container.getAllAsync(TYPE.Controller)];
        }
        if (forceControllers) {
