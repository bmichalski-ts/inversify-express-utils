...
var getControllersFromContainer = function (container, forceControllers) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (container.isBound(constants_1.TYPE.Controller)) {
            return [2, container.getAllAsync(constants_1.TYPE.Controller)];
        }
        if (forceControllers) {
...
function getControllerParameterMetadata(constructor) {
    ...
    if (genericMetadata !== undefined && parameterMetadata !== undefined) {
        return __assign(__assign({}, parameterMetadata), genericMetadata);
    }
    if (genericMetadata !== undefined) {
        return genericMetadata;
    }
